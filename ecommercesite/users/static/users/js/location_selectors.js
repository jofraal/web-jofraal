 ...
 * Usa vistas API para obtener datos dinámicamente con implementación de caché y sistema de fallback
 */
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function fetchWithFallback(primaryUrl, fallbackUrl) {
        try {
            ...
            console.warn(`Error al cargar desde ${primaryUrl}:`, error);
    ...
    function loadDepartments() {
        ...
        // Intentar cargar desde la API principal con fallback a la alternativa
    ...
    function loadProvinces(department) {
        ...
        console.log('Solicitando provincias desde:', primaryUrl);
    ...
    function loadDistricts(department, province) {
        ...
        console.log('Solicitando distritos desde:', primaryUrl);
